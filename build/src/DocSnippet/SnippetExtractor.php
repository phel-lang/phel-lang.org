...
final class SnippetExtractor
{
    ...
    /**
     * Generated by `composer build` from the Phel docstrings, not authored here.
     * Their fences hold signature templates such as `(apply f expr*)`, not
     * programs.
     */
    private const GENERATED_API_PAGES = '~(^|/)content/documentation/reference/api/~';

    public function coversFile(string $path): bool
    {
        return preg_match(self::GENERATED_API_PAGES, str_replace('\\', '/', $path)) !== 1;
    }
